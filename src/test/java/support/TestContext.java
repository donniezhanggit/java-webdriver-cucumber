...
public class TestContext {
    ...
    public static HashMap <String, String> loadFromFile() throws  Exception {
        System.out.println(">>>>>>>" + System.getProperty("user.dir") + "src/test/resources/downloads/data.yaml");
        File file = new File(System.getProperty("user.dir") + "/src/test/resources/downloads/data.yaml");
      //  File file = new File("/Users/andreitravkin/IdeaProjects/java-webdriver-cucumbersrc/test/resources/downloads/data.yaml");
